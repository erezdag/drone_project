...
class WindLogger():
    ...
    def __init__(self,config_data,wind_dev_epics,logger_wind_dev_epics):
        ...
        self.logger_wind_dev_epics.folder_name2 = self.config_data['logger_wind']['save_folder']
        self.logger_wind_dev_epics.project_name2 = self.config_data['logger_wind']['project_name']
    ...
    def write_to_file(self):
        ...
        self.file_name_and_path = os.path.join(self.logger_wind_dev_epics.get('folder_name2', as_string=True), self.logger_wind_dev_epics.get('file_name2', as_string=True))
...
if __name__ == "__main__":
    ...
    wind_logger.logger_wind_dev_epics.file_name2 = wind_logger.logger_wind_dev_epics.get('project_name2' , as_string=True) \
